...
def main():
    ...
    try:
        ...
        # Generate HTML report with reasons (no longer need separate report)
        generator.save_html_report("", "stock_report.html")
        ...
        print(f"🌐 HTML report saved to: stock_report.html")
